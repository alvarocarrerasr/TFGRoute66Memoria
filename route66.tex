...
Se ha decidido emplear los siguientes patrones en el diseño de la arquitectura:
\begin{itemize}
\item MVC (Modelo Vista Controlador), como patrón empleado en la interfaz de usuario.
\end{itemize}
