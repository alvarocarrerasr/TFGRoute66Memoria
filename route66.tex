...
\usepackage{geometry}
\geometry{showframe=true,a4paper,left=2cm, right=1.5cm,top=1.5cm,bottom=1.5cm, includehead,includefoot}
\usepackage{fancyhdr}
...
El objetivo de este proyecto es el de realizar una aplicación Android para un restaurante de comida rápida, que cuente con un sistema de ludificación. En concreto, se realizará basándose en la idea desarrollada en el Trabajo de Fin de Grado de Dª Cristina Martínez Martínez\cite{cristinatfg}.
...
Este Plan de Desarrollo del Proyecto empleará la metodología UPedu (Unified Process for Education)
