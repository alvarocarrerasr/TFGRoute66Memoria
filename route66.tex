...
\begin{req}
	...
	\addrow{Descripción}{La aplicación utilizará la biblioteca de persistencia Room \cite{roompersistence} como gestor de la base de datos local no gestionada por Firebase}
\end{req}\\\stepcounter{nonFunctionalRequirements}
