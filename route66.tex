...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/1.png}
\includegraphics[scale=0.15]{images/userguide/2.png}
\includegraphics[scale=0.15]{images/userguide/3.png}
\caption{Capturas de pantalla del selector de niveles, el menú principal sin puntuaciones asociadas y el menú principal con puntuaciones asociadas.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/4.png}
\caption{Vista “Mi perfil“.}
\end{center}
\end{figure}

\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/5.png}
\includegraphics[scale=0.15]{images/userguide/6.png}
\caption{Vista “Mis logros“, sin logros obtenidos (izquierda) y con logros obtenidos (derecha)}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/7.png}
\includegraphics[scale=0.15]{images/userguide/8.png}
\caption{Vista “Mis insignias“, sin insignias conseguidas (izquierda) y con insignias (derecha) }
\end{center}
\end{figure}

\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/9.png}
\includegraphics[scale=0.15]{images/userguide/10.png}
\caption{Vista “Mis premios“, sin premios conseguidos (izquierda) y con premios (derecha) }
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/11.png}
\includegraphics[scale=0.15]{images/userguide/12.png}
\includegraphics[scale=0.15]{images/userguide/13.png}
\caption{Vistas “Invitar“, “Ranking global“ y “Equipos“      }
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/14.png}
\includegraphics[scale=0.15]{images/userguide/15.png}
\includegraphics[scale=0.15]{images/userguide/16.png}
\caption{Vista principal de un equipo, sin y con el menú de opciones deplegado con el rol administrador y con el menú desplegado con el rol usuario normal.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/15a.png}
\includegraphics[scale=0.15]{images/userguide/17.png}
\includegraphics[scale=0.15]{images/userguide/18.png}
\caption{Vistas “Gestionar usuario“ y “Configuración del equipo“. Esta última, a la izquierda, con el seguro de borrado activado y a la derecha, sin activar. }
\end{center}
\end{figure}

\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/19.png}
\includegraphics[scale=0.15]{images/userguide/20.png}
\caption{Vistas “Código QR del equipo“ y “Añadir miembro al equipo“ .}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/21.png}
\includegraphics[scale=0.15]{images/userguide/22.png}
\caption{Vistas “Salir del equipo“, con y sin el seguro activado.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/23.png}
\includegraphics[scale=0.15]{images/userguide/24.png}
\caption{Vistas de un nivel. A la izquierda, miembros de la aplicación que se encuentran en ese nivel. A la derecha, misiones correspondientes al mismo, indicando para cada una de ellas su tipo.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/25.png}
\includegraphics[scale=0.15]{images/userguide/26.png}
\includegraphics[scale=0.15]{images/userguide/27.png}
\caption{Vistas correspondientes a una misión de tipo social. A la izquierda, misión social del nivel Chicago (no se puede modificar la misión); en el centro,  misión social libre y a la derecha, misión social en comprobación. }
\end{center}
\end{figure}

\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/28.png}
\includegraphics[scale=0.15]{images/userguide/29.png}
\includegraphics[scale=0.15]{images/userguide/30.png}
\caption{Vistas correspondientes a una misión de tipo competitivo. A la izquierda, descripción de la puntuación que se debe alcanzar; en el centro, juego en progreso y a la derecha, mensaje de no haber completado la misión. }
\end{center}
\end{figure}

\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.15]{images/userguide/31.png}
