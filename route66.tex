...
\begin{tabular}{|l|l|l|l|}
\hline
\textbf{ID}           &  & \textbf{Nombre}                        &                   \\ \hline
\textbf{Descripción}  & \multicolumn{3}{l|}{}                                         \\ \hline
\textbf{Probabilidad} &  & \multirow{2}{*}{\textbf{Consecuencia}} & \multirow{2}{*}{} \\ \cline{1-2}
\textbf{Impacto}      &  &                                        &                   \\ \hline
\textbf{Estrategia}   &  & \textbf{Plan de contingencia}          &                   \\ \hline
\end{tabular}
\caption{Plantilla vacía de un riesgo}
\end{table}
