...
Tutora:\\
\textbf{Dña. Margarita Gonzalo Tasis}\end{large}
\end{flushright}
\end{titlepage}
\clearpage
...
5         & Transición   & 13/04/2018           & 11/04/2018            & 24/04/2018        & 25/04/2018         & 1 día                   \\ \hline
\end{tabular}%
}
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		...
  		\item El sistema pregunta al usuario el nombre del usuario que desea añadir. %4
  		\item El usuario introduce el nombre. %5
  		\item El sistema comprueba el dato y añade al usuario al equipo. %6
  		\end{enumerate}
  }
  \addrow{Flujos alternativos}{
  		\begin{itemize}
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		...
  		\item El sistema muestra al usuario el listado de niveles. %2
  		\item El usuario selecciona un nivel. %3
  		\item El sistema muestra al usuario las distintas misiones que conforman el nivel. %4
  		\end{enumerate}
  }
  \addrow{Flujos alternativos}{
  		\begin{itemize}
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		\begin{enumerate}
  		\item El sistema obtiene los detalles de la misión, a partir del identificador de misión que se ha proporcionado. %1
  		\item El sistema muestra al usuario el reto social que debe realizar para marcar la misión como completada. %2
  		\item El sistema comprueba si existe algún registro de esta misión social asociado al usuario. Este registro deberá haberse registrado con fecha posterior a la hora de entrada, por primera vez a la actividad. %3
  		\end{enumerate}
  }
  \addrow{Flujos alternativos}{
  		\begin{itemize}
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		...
  		\item El sistema muestra al usuario los detalles de ese equipo (miembros, nombre, avatar, logros y premios). %4
  		\end{enumerate}
  }
  \addrow{Flujos alternativos}{
  		\begin{itemize}
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		...
  		\item El sistema pregunta al usuario el nombre del equipo. %2
  		\item El usuario introduce el dato solicitado. %3
  		\item El sistema  crea el equipo. %4
  		\end{enumerate}
  }
  \addrow{Flujos alternativos}{
  		\begin{itemize}
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		...
  		\item El sistema pregunta al usuario cuál es su correo electrónico y su contraseña. %2
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		\begin{enumerate}
  		\item El sistema recibe una llamada de \textit{Firebase Invites} que le proporciona el identificador del usuario que ha enviado la invitación. %1
  		\item Se pasa al caso de uso “Registrarse“, junto con el dato del usuario que ha enviado la invitación. %2
  		\item El sistema envía una solicitud \textit{HTTP} contra un \textit{endpoint} que habilita la función \textit{lambda} que añade los puntos y notifica al usuario que ha generado la invitación. %3
  		\end{enumerate}
  }
  \addrow{Flujos alternativos}{
  		\begin{itemize}
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		\begin{enumerate}
  		\item El usuario elige “Enviar invitación“. %1
  		\item El sistema pregunta al usuario qué mensaje desea añadir a la invitación. %2
  		\item El usuario introduce el mensaje. %3
  		\item El sistema comprueba el mensaje y muestra al usuario el cuadro de diálogo del sistema para enviar la invitación. %4
  		\item El usuario comparte la invitación por correo electrónico. %5
  		\end{enumerate}
  }
  \addrow{Flujos alternativos}{
  		\begin{itemize}
...
\begin{usecase}
  ...
  \addrow{Flujo principal}{
  		\begin{enumerate}
  		\item El usuario elige “Salir de un equipo“. %1
  		\item El sistema muestra al usuario el conjunto de grupos a los que pertenece. %2
  		\item El usuario escoge un grupo. %3
  		\item El sistema comprueba la posibilidad de que el usuario abandone el equipo. %4
...
Por otro lado, se ha decidido rediseñar parte de la estrategia del juego, centrándose siempre en la idea desarrollada en el T.F.G. sobre el que está basado este proyecto \cite{cristinatfg}, al no contar con el suficiente detalle que se ha requerido en la implementación. De esta forma, los niveles y los detalles concretos de los mismos son los siguientes:
...
\bibitem{roompersistence} \textsc{Android Developers Official Website}. \textit{Room Persistence Library}. Fecha de última visita: 23/01/2018 \url{https://developer.android.com/topic/libraries/architecture/room.html}.
...
\bibitem{burgerk} \textsc{Burger King},\textit{Aplicación móvil Burger King para \textit{Android}} \url{https://play.google.com/store/apps/details?id=es.burgerking.android}.
...
\bibitem{iebsctj} \textsc{Ferran Altarriba Bertran. IEBS School} \textit{Tipos de jugadores en \textit{Gamification}: teoría Bartle}. Fecha de última visita: 6 de Noviembre de 2017, \url{http://www.iebschool.com/blog/tipos-jugadores-gamification-2-innovacion/}.  
...
\bibitem{firebaseuifirestore} \textsc{Firebase Firestore} \textit{FirebaseUI for Cloud Firestore}. Fecha de última visita 01/02/2018. \url{https://github.com/firebase/FirebaseUI-Android/blob/master/firestore/README.md}.
...
\bibitem{firebase} \textsc{Firebase}. Página Web de \textit{Firebase}. Fecha de última visita: 08/02/2018.
...
\bibitem{kfcapp} \textsc{KFC},\textit{Aplicación móvil KFC para \textit{Android}} \url{https://play.google.com/store/apps/details?id=es.kfc.spain}.
...
\bibitem{kotlin} \textsc{Kotlin Programming Language. IntelliJ}. Página Web del lenguaje de programación \textit{Kotlin}. Fecha de última visita: 08/02/2018 \url{https://kotlinlang.org/}.
...
\bibitem{mcdo} \textsc{McDonalds},\textit{Aplicación móvil McDonalds para \textit{Android}} \url{https://play.google.com/store/apps/details?id=com.mcdonalds.android}.

\bibitem{monopolymcdo} \textsc{McDonalds}. \textit{Monopoly Ganador de McDonalds}. Fecha de última visita: 20/01/2018 \url{https://www.mcdonalds.es/sites/default/files/mcdonalds_lanza_su_nuevo_monopoly_ganador.pdf}.

\bibitem{firebaseadvdis} \textsc{Nathan, Lee. FreeCodeCamp} \textit{Firebase Pros and Cons and How to Deal With the Cons}. Fecha de última visita 08/02/2018 \url{https://medium.com/@leetheguy/firebase-pros-and-cons-ce37c766190a}.
...
\bibitem{mikepenzmaterialdrawer} \textsc{Penz, Mike} \textit{MaterialDrawer}. Fecha de última visita 01/02/2018. \url{https://github.com/mikepenz/MaterialDrawer}.
...
\bibitem{disadvKotlin} \textsc{Timokhina, Valeria. DZone}. \textit{The Pros and Cons of Kotlin for Android Development}. Fecha de última visita 08/02/2018. \url{https://dzone.com/articles/the-pros-and-cons-of-kotlin-for-android-developmen}.
...
\bibitem{tapikinull} \textsc{Zhitnitsky, Alex}. \textit{The Top 10 Exception Types in Production Java Applications - Based on 1B Events}. Fecha de última visita: 08/02/2018 \url{https://blog.takipi.com/the-top-10-exceptions-types-in-production-java-applications-based-on-1b-events}.
...
\bibitem{androidpacktpub} \textsc{Boyer, Rick \& Mew, Kyle}. \textit{Android Application Development Cookbook - Second Edition. Over 100 recipes to help you solve the most common problems faced by Android Developers today}. Editorial \textit{PacktPub}.
...
\bibitem{databasedesign} \textsc{Hills, Ted}. \textit{NoSQL and SQL Data Modelling. Bringing together data, semantics and software}. Editorial \textit{Technics Publications}.
