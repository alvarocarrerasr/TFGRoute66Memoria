...
2         & Elaboración  & 16/02/2018           & 11/02/2018            &                   & 20/02/2018         &                         \\ \hline
3         & Construcción &                      & 20/02/2018            &                   & 01/04/2018         &                         \\ \hline
...
Una aplicación Android está basada en cuatro tipos de componentes \cite{androidfund}:

\begin{enumerate}
\item Actividades:
\item Servicios:
\item Provedores de contenidos (\textit{“Content providers“}):
\item Receptores de mensajes (\textit{“Broadcast receivers“}):
\end{enumerate}
...
\bibitem{fireference} \textsc{Firebase} Trabajar con arreglos, listas y conjuntos \url{https://firebase.google.com/docs/firestore/solutions/arrays?hl=es-419}

\bibitem{androidfund} \textsc{Android Reference Guide} Aspectos fundamentales de la aplicación \url{https://developer.android.com/guide/components/fundamentals.html}
...
\bibitem{databasedesign} \textsc{Hills, Ted}. NoSQL and SQL Data Modelling. Bringing together data, semantics and software
