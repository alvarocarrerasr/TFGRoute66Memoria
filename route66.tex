...
\subsubsection{Telepizza \cite{telepizza}}

\subsubsection{Domino's Pizza \cite{dominospizza}}

\subsection{Otras aplicaciones analizadas}
\subsubsection{Danone}
...
\bibitem[DominosPizza]{dominospizza} \textsc{Domino's Pizza},\textit{Aplicación móvil Domino's Pizza para Android} \url{https://play.google.com/store/apps/details?id=com.dominos.caribbean}

\bibitem[Telepizza]{telepizza} \textsc{Telepizza},\textit{Aplicación móvil Telepizza para Android} \url{https://play.google.com/store/apps/details?id=com.telepizza}
