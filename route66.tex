...
\item En \textit{Shared Preferences}: empleada para el almacenamiento persistente de la configuración del perfil del usuario, así como los parámetros principales de la aplicación (por ejemplo, el tono de notificación).
\end{enumerate}
