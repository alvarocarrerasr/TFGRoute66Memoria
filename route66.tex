...
\subsubsection{Relacionados con los usuarios}
...
\subsubsection{Relacionados con los grupos}
...
\subsubsection{Relacionados con el ranking}
\begin{req}
...
\subsubsection{Otros aspectos}

\begin{req}
	\addheading{\textbf{RF\arabic{functionalRequirements}}}{\textit{Engagement} del usuario/grupo}
	\addrow{Descripción}{El sistema medirá el \textit{engagement} del usuario/grupo con la aplicación.}
\end{req}\\\stepcounter{functionalRequirements}
...
\subsubsection{Requisitos funcionales de información}
...
\subsubsection{Relacionados con los grupos/equipos}
\begin{req}
...
\subsubsection{Software a utilizar para el despliegue de la aplicación.}
\begin{req}
	\addheading{\textbf{RNF\arabic{nonFunctionalRequirements}}}{Datos estadísticos de la aplicación.}
	\addrow{Descripción}{El sistema utilizará Firebase Analytics para la gestión de ciertas estadísiticas (número de usuarios de la aplicación, usuarios activos, datos de bloqueos, efectividad de las notificaciones...)}
\end{req}\\\stepcounter{nonFunctionalRequirements}
