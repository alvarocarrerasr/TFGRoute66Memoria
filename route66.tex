...
\hline
\textbf{ID}                   & R0                                                                                                                         \\ \hline
\textbf{Nombre}               & Falta de experiencia del alumno                                                                                            \\ \hline
\textbf{Descripción}          & \makecell[l]{El alumno ha realizado prácticas en Android, pero puede encontrarse\\ en momentos en los que requiera experiencia adicional.} \\ \hline
\textbf{Consecuencia}         & Ralentización del trabajo.                                                                                                 \\ \hline
\textbf{Probabilidad}         & Media.                                                                                                                     \\ \hline
\textbf{Impacto}              & Bajo.                                                                                                                      \\ \hline
\textbf{Estrategia}           & Reservar el riesgo.                                                                                                        \\ \hline
\textbf{Plan de acción}       & \makecell[l]{Buscar información y ayuda, ya sea preguntando a la tutora del\\ trabajo o utilizando otros medios.}                          \\ \hline
\textbf{Plan de contingencia} & Revisión de conocimientos existentes.                                                                                      \\ \hline
\end{tabular}}
\end{table}
\begin{table}[H]
\resizebox{0.9\textwidth}{!}{%
...
\hline
\textbf{ID}                   & R1                                                                                                                             \\ \hline
\textbf{Nombre}               & Retraso en la planificación                                                                                                    \\ \hline
\textbf{Descripción}          & \makecell[l]{Debido a errores en la estimación, la planificación no se ajusta \\a la realidad y se producen demoras en las fechas de entrega.} \\ \hline
\textbf{Consecuencia}         & Retraso en la entrega de los artefactos.                                                                                      \\ \hline
\textbf{Probabilidad}         & Alta                                                                                                                           \\ \hline
\textbf{Impacto}              & Crítico                                                                                                                        \\ \hline
\textbf{Estrategia}           & Reservar el riesgo                                                                                                             \\ \hline
\textbf{Plan de acción}       & Realizar una nueva planificación más realista.                                                                                 \\ \hline
\textbf{Plan de contingencia} & Realizar revisiones periódicas del calendario de planificación.                                                                \\ \hline
\end{tabular}}
\end{table}
\begin{table}[H]
\resizebox{0.9\textwidth}{!}{%
...
\hline
\textbf{ID}                   & R2                                                                                                                               \\ \hline
\textbf{Nombre}               & Adelantos en la planificación                                                                                                    \\ \hline
\textbf{Descripción}          & \makecell[l]{Debido a errores en la estimación, la planificación no se ajusta\\ a la realidad y se producen adelantos en las fechas de entrega.} \\ \hline
\textbf{Consecuencia}         & Modificación de toda la planificación.                                                                                           \\ \hline
\textbf{Probabilidad}         & Alta                                                                                                                             \\ \hline
\textbf{Impacto}              & Crítico                                                                                                                          \\ \hline
\textbf{Estrategia}           & Reservar el riesgo                                                                                                               \\ \hline
\textbf{Plan de acción}       & Realizar una nueva planificación más realista.                                                                                   \\ \hline
...
\hline
\textbf{ID}                   & R3                                                                                                                                                                           \\ \hline
\textbf{Nombre}               & Falta de experiencia en grandes proyectos.                                                                                                                                   \\ \hline
\textbf{Descripción}          & \makecell[l]{El equipo no cuenta con experiencia propia de proyectos de gran \\extensión que le permita calcular mejor las estimaciones, así\\ como realizar el proyecto con mayor celeridad.} \\ \hline
\textbf{Consecuencia}         & Peor organización y estimaciones. Grandes picos de trabajo.                                                                                                                  \\ \hline
\textbf{Probabilidad}         & Alta                                                                                                                                                                         \\ \hline
\textbf{Impacto}              & Alto                                                                                                                                                                         \\ \hline
\textbf{Estrategia}           & Reducción el riesgo                                                                                                                                                          \\ \hline
\textbf{Plan de acción}       & Realizar una nueva planificación.                                                                                                                                            \\ \hline
\textbf{Plan de contingencia} & Realizar revisiones periódicas del calendario de planificación.                                                                                                              \\ \hline
\end{tabular}}
\end{table}
\begin{table}[H]
...
\hline
\textbf{ID}                   & R4                                                                                                                                                       \\ \hline
\textbf{Nombre}               & Falta de disponibilidad                                                                                                                                  \\ \hline
\textbf{Descripción}          & El alumno no puede continuar con el trabajo por falta de disponibilidad.                                                                                 \\ \hline
\textbf{Consecuencia}         & \makecell[l]{Dependerá del tiempo en el que esté no disponible y las holguras\\ en la planificación. Si es muy largo, puede suponer la no entrega\\ del trabajo a tiempo.} \\ \hline
\textbf{Probabilidad}         & Baja.                                                                                                                                                    \\ \hline
\textbf{Impacto}              & Crítico.                                                                                                                                                 \\ \hline
\textbf{Estrategia}           & Reservar el riesgo.                                                                                                                                      \\ \hline
\textbf{Plan de acción}       & \makecell[l]{Realizar una nueva planificación basándose en las nuevas fechas \\de disponibilidad.}                                                                       \\ \hline
\textbf{Plan de contingencia} & Monitorizar la disponibilidad del alumno.                                                                                                                \\ \hline
\end{tabular}}
\end{table}
\begin{table}[H]
\resizebox{0.9\textwidth}{!}{%
...
\hline
\textbf{ID}                   & R5                                                                                                                           \\ \hline
\textbf{Nombre}               & Pérdida de datos                                                                                                             \\ \hline
\textbf{Descripción}          & \makecell[l]{Por cualquier motivo, se pierde total o parcialmente cualquiera de los\\ artefactos ya realizados o en proceso de realización.} \\ \hline
\textbf{Consecuencia}         & Ralentización del trabajo. Repetición de los artefactos perdidos.                                                            \\ \hline
\textbf{Probabilidad}         & Bajo.                                                                                                                        \\ \hline
\textbf{Impacto}              & Crítico.                                                                                                                     \\ \hline
\textbf{Estrategia}           & Evitación del riesgo.                                                                                                        \\ \hline
\textbf{Plan de acción}       & No se aplica.                                                                                                                \\ \hline
\textbf{Plan de contingencia} & \makecell[l]{Realización de copias de seguridad y uso de un sistema de control\\ de versiones (ver apartado gestión de configuraciones).}    \\ \hline
\end{tabular}}
\end{table}
\begin{table}[H]
\resizebox{0.9\textwidth}{!}{%
...
\hline
\textbf{ID}                   & R6                                                                                                         \\ \hline
\textbf{Nombre}               & Falta de medios software                                                                     de desarrollo  \\ \hline
\textbf{Descripción}          & \makecell[l]{Las herramientas designadas para desarrollar el proyecto fallan,\\ desaparecen o dejan de estar disponibles.} \\ \hline
\textbf{Consecuencia}         & \makecell[l]{Ralentización muy alta del trabajo. \\Repetición de los artefactos perdidos. }                                \\ \hline
\textbf{Probabilidad}         & Bajo.                                                                                                      \\ \hline
\textbf{Impacto}              & Crítico.                                                                                                   \\ \hline
\textbf{Estrategia}           & Evitación del riesgo.                                                                                      \\ \hline
\textbf{Plan de acción}       & No se aplica.                                                                                              \\ \hline
\textbf{Plan de contingencia} & \makecell[l]{Utilización de herramientas profesionales, aplicación de las \\últimas actualizaciones.}                      \\ \hline
\end{tabular}}
\end{table}
...
\hline
\textbf{ID}                   & R7                                                                                                           \\ \hline
\textbf{Nombre}               & Falta de medios hardware de desarrollo                                                                       \\ \hline
\textbf{Descripción}          & \makecell[l]{Las herramientas designadas para desarrollar el proyecto fallan o \\dejan de estar disponibles.}                \\ \hline
\textbf{Consecuencia}         & Adquisición de nuevos materiales.                                                                            \\ \hline
\textbf{Probabilidad}         & Bajo.                                                                                                        \\ \hline
\textbf{Impacto}              & Alto.                                                                                                        \\ \hline
\textbf{Estrategia}           & Evitación del riesgo.                                                                                        \\ \hline
\textbf{Plan de acción}       & No se aplica.                                                                                                \\ \hline
\textbf{Plan de contingencia} & \makecell[l]{Realización de copias de seguridad de los artefactos, para evitar\\ su pérdida en caso de ocurrir este riesgo.} \\ \hline
\end{tabular}}
\end{table}
...
\hline
\textbf{ID}                   & R8                                                                              \\ \hline
\textbf{Nombre}               & Diseño pobre o incorrecto.                                                      \\ \hline
\textbf{Descripción}          & El diseño realizado del sistema es pobre o incorrecto.                          \\ \hline
\textbf{Consecuencia}         & Ralentización del trabajo.                                                      \\ \hline
\textbf{Probabilidad}         & Medio.                                                                          \\ \hline
\textbf{Impacto}              & Crítico.                                                                        \\ \hline
\textbf{Estrategia}           & Reducción del riesgo.                                                           \\ \hline
\textbf{Plan de acción}       & Rediseñar la arquitectura del sistema.                                          \\ \hline
\textbf{Plan de contingencia} & \makecell[l]{Realizar revisiones con el cliente y realizar pruebas sobre el modelo\\ diseñado.} \\ \hline
\end{tabular}}
\end{table}
