...
\item Es actualmente un estándar en programación de aplicaciones \textit{Android}: El apoyo que Google está dando al lenguaje de programación es tal que resulta más que recomendable empezar a utilizarlo y acostumbrarse al mismo.
\end{enumerate}
...
Route66 cuenta con las siguientes actividades:
	...
	\begin{enumerate}
		...
		\end{enumerate}
		\item \textit{SettingsFragment}: es el fragmento encargado de mostrar un panel de configuración básica para ajustar el tono de notificación que se deberá utilizar para notificar al usuario.
	\end{enumerate}
