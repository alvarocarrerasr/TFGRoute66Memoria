...
\begin{req}
	...
	\addrow{Descripción}{El sistema permitirá mostrar los círculos de progresos relativos a cada usuario.}
\end{req}\\\stepcounter{functionalRequirements}
...
\begin{req}
	...
	\addrow{Descripción}{Se identificarán a los usuarios por el identificador único de usuario generado por Firebase.}
\end{req}\\\stepcounter{nonFunctionalRequirements}
...
\begin{req}
	...
	\addrow{Descripción}{El sistema utilizará Firebase Invitates para invitar a un usuario a la aplicación.}
\end{req}\\\stepcounter{nonFunctionalRequirements}
...
Los usuarios de la aplicación contarán con un conjunto de niveles, misiones, premios e insignias que deberán ir obteniendo o completando para avanzar en la aplicación. Se ha decidido incluir este apartado al no haberlo encontrado lo suficientemente desarrollado en el \cite{cristinatfg} T.F.G. sobre el que está basada la idea de este proyecto.
...
\item \textbf{Image Compressor} \cite{icompressordependencies}: Biblioteca de comprensión de imágenes.
...
\begin{test}
  ...
  \addrow{Resultado obtenido}{Efectivamente se visualzan los logros del usuario, pero se muestran también aquellos con una puntuación nula (correspondiente a misiones aún no completadas o validadas). Se decide ocultar las mismas.}
\end{test}\\\stepcounter{test}
